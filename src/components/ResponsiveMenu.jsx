...
function ResponsiveMenu({ showMenu, setShowMenu }) {
  return (
    <div
      ...
      } flex bottom-0 top-0 z-20 h-screen w-[75%] flex-col justify-between bg-gray-950 px-8 pb-6 pt-16 text-black md:hidden rounded-r-xl shadow-md transition-all fixed`}
    >
      <div>
